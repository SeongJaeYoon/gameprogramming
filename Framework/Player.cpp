...
Player::Player()
	...
	moveSpeed(5.0f),
	col(*transform, Vector2(32.0f, 64.0f))
{
	//애니메이션 적용 방법
	...
	SheetAnimation* sanim = new SheetAnimation(1, 17.0f,L"resources/player/sheet.png",32,64,5);	//애니메이션 생성, 해당 애니메이션의 state는 1, 초당 16회 그림
	...
	transform->SetPosition(1600/2, 900/2);	//Player의 초기 위치 설정
...
void Player::Update()
{
	...
	if (InputManager::GetMyKeyState(VK_SPACE))
		Scene::ChangeScene(new TestScene2());
	*/
